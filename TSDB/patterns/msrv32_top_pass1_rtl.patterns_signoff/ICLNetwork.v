...
// Filename       : ./TSDB/patterns/msrv32_top_pass1_rtl.patterns_signoff/ICLNetwork.v
// Idstamp        : 2022.2:ec94:6099:0:0000
// Date           : Tue Apr  7 17:30:53 2026
//
...
wire tms_p, trst_p, tdi_p, tck_p, scan_en, tdo_p;

event       before_finish;
assign tms_p = _ibus[4];
assign trst_p = _ibus[3];
assign tdi_p = _ibus[2];
assign tck_p = _ibus[1];
