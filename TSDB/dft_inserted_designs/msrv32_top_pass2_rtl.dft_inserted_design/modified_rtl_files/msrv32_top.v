...
module msrv32_top #(
   ...
   //IO pad cell definations
     ...
     wire [2:0] occ1_clock_sequence, occ2_clock_sequence;
     wire msrv32_top_pass2_rtl_tessent_sib_sri_ctrl_inst_so, 
          msrv32_top_pass2_rtl_tessent_sib_lbist_inst_so, 
          msrv32_top_pass2_rtl_tessent_sib_occ_inst_so, 
          msrv32_top_pass2_rtl_tessent_sib_edt_inst_so, 
          msrv32_top_pass2_rtl_tessent_tdr_sri_ctrl_inst_so, 
          msrv32_top_pass2_rtl_tessent_sib_sri_ctrl_inst_to_select, 
          async_set_reset_dynamic_disable_inv_ts2, ms_riscv32_mp_rst_in_toCore, 
          shift_capture_clock_pad_C, ms_riscv32_mp_clk_in_p_toCore, 
          ijtag_to_sel, ramclk_p_toCore, ijtag_so, ijtag_so_ts1, 
          edt_channels_out, edt_bypass, edt_low_power_shift_en, 
          ijtag_to_sel_ts1, ijtag_so_ts2, ijtag_to_sel_ts2, ijtag_so_ts3, 
          to_edt_scan_in, ijtag_so_ts4, ijtag_so_ts5, to_edt_channels_in, 
          edt_single_bypass_chain_out, lbist_en, lbist_low_power_shift_en, 
          ccm_scan_en, ccm_scan_out, capture_en_out, shift_clock_out, inv_Y, 
          msrv32_top_pass2_rtl_tessent_lbist_tmp_net, shift_clock_src_p_pad_C, 
          edt_lbist_clock, edt_sib_en, misr_accumulate_en, lbist_prpg_en, 
          lbist_reset;
     wire [1:0] shift_en_out, ncp;
   ...
   //  ipad tdi_pad (.PAD(tdi), .C());
    ...
    // opad tdo_pad ( .I(), .OEN(1'b1), .PAD(tdo) );
     ...
     ipad shift_capture_clock_pad (.PAD(shift_capture_clock), .C(shift_capture_clock_pad_C));
     ...
     ipad shift_clock_src_p_pad (.PAD(shift_clock_src_p), .C(shift_clock_src_p_pad_C));
     ipad edt_clock_pad (.PAD(edt_clock), .C(edt_clock_fromPad));

     opad control_chain_scan_out_pad ( .I(ccm_scan_out), .OEN(EN5_en1), .PAD(control_chain_scan_out));
     ...
     opad edt_channel_out1_p_pad ( .I(edt_channels_out), .OEN(1'b1), .PAD(edt_channel_out1_p));
...
/////////////////////////////////////////////////
  ...
  msrv32_top_pass1_rtl_tessent_sib_1 msrv32_top_pass1_rtl_tessent_sib_sri_inst(
      ...
      .ijtag_from_so(msrv32_top_pass2_rtl_tessent_sib_sri_ctrl_inst_so), .ijtag_to_sel(msrv32_top_pass1_rtl_tessent_sib_sri_inst_to_select)
  );
  ...
  or02 tessent_persistent_cell_async_set_reset_dynamic_disable(
      .A0(msrv32_top_pass2_rtl_tessent_lbist_tmp_net), .A1(async_set_reset_static_disable), .Y(tessent_persistent_cell_async_set_reset_dynamic_disable_Y)
  );
  ...
  msrv32_top_pass1_rtl_tessent_bscan_logical_group_DEF msrv32_top_pass1_rtl_tessent_bscan_logical_group_DEF_inst(
      ...
      .ms_riscv32_mp_clk_in_p_toCore(ms_riscv32_mp_clk_in_p_toCore), .ms_riscv32_mp_data_hready_in_fromPad(ms_riscv32_mp_data_hready_in_fromPad), 
      ...
      .ms_riscv32_mp_rst_in_toCore(ms_riscv32_mp_rst_in_toCore), .ms_riscv32_mp_sirq_in_fromPad(ms_riscv32_mp_sirq_in_fromPad), 
      .ms_riscv32_mp_sirq_in_toCore(), .ms_riscv32_mp_tirq_in_fromPad(ms_riscv32_mp_tirq_in_fromPad), 
      .ms_riscv32_mp_tirq_in_toCore(), .ramclk_p_fromPad(ramclk_p_fromPad), .ramclk_p_toCore(ramclk_p_toCore), 
  ...
  msrv32_top_pass2_rtl_tessent_sib_1 msrv32_top_pass2_rtl_tessent_sib_lbist_inst(
      .ijtag_reset(test_logic_reset), .ijtag_sel(msrv32_top_pass1_rtl_tessent_sib_sri_inst_to_select), 
      .ijtag_si(msrv32_top_pass1_rtl_tessent_sib_sri_ctrl_inst_so), .ijtag_ce(capture_dr_en), 
      .ijtag_se(shift_dr_en), .ijtag_ue(update_dr_en), .ijtag_tck(tck_i_C), .ijtag_so(msrv32_top_pass2_rtl_tessent_sib_lbist_inst_so), 
      .ijtag_from_so(ijtag_so_ts3), .ijtag_to_sel(ijtag_to_sel_ts2)
  );

  msrv32_top_pass2_rtl_tessent_sib_1 msrv32_top_pass2_rtl_tessent_sib_occ_inst(
      .ijtag_reset(test_logic_reset), .ijtag_sel(msrv32_top_pass1_rtl_tessent_sib_sri_inst_to_select), 
      .ijtag_si(msrv32_top_pass2_rtl_tessent_sib_lbist_inst_so), .ijtag_ce(capture_dr_en), 
      .ijtag_se(shift_dr_en), .ijtag_ue(update_dr_en), .ijtag_tck(tck_i_C), .ijtag_so(msrv32_top_pass2_rtl_tessent_sib_occ_inst_so), 
      .ijtag_from_so(ijtag_so_ts1), .ijtag_to_sel(ijtag_to_sel)
  );

  msrv32_top_pass2_rtl_tessent_sib_1 msrv32_top_pass2_rtl_tessent_sib_edt_inst(
      .ijtag_reset(test_logic_reset), .ijtag_sel(msrv32_top_pass1_rtl_tessent_sib_sri_inst_to_select), 
      .ijtag_si(msrv32_top_pass2_rtl_tessent_sib_occ_inst_so), .ijtag_ce(capture_dr_en), 
      .ijtag_se(shift_dr_en), .ijtag_ue(update_dr_en), .ijtag_tck(tck_i_C), .ijtag_so(msrv32_top_pass2_rtl_tessent_sib_edt_inst_so), 
      .ijtag_from_so(ijtag_so_ts2), .ijtag_to_sel(ijtag_to_sel_ts1)
  );

  msrv32_top_pass2_rtl_tessent_sib_1 msrv32_top_pass2_rtl_tessent_sib_sri_ctrl_inst(
      .ijtag_reset(test_logic_reset), .ijtag_sel(msrv32_top_pass1_rtl_tessent_sib_sri_inst_to_select), 
      .ijtag_si(msrv32_top_pass2_rtl_tessent_sib_edt_inst_so), .ijtag_ce(capture_dr_en), 
      .ijtag_se(shift_dr_en), .ijtag_ue(update_dr_en), .ijtag_tck(tck_i_C), .ijtag_so(msrv32_top_pass2_rtl_tessent_sib_sri_ctrl_inst_so), 
      .ijtag_from_so(msrv32_top_pass2_rtl_tessent_tdr_sri_ctrl_inst_so), .ijtag_to_sel(msrv32_top_pass2_rtl_tessent_sib_sri_ctrl_inst_to_select)
  );

  msrv32_top_pass2_rtl_tessent_tdr_sri_ctrl msrv32_top_pass2_rtl_tessent_tdr_sri_ctrl_inst(
      .ijtag_reset(test_logic_reset), .ijtag_sel(msrv32_top_pass2_rtl_tessent_sib_sri_ctrl_inst_to_select), 
      .ijtag_si(msrv32_top_pass2_rtl_tessent_sib_edt_inst_so), .ijtag_ce(capture_dr_en), 
      .ijtag_se(shift_dr_en), .ijtag_ue(update_dr_en), .ijtag_tck(tck_i_C), .mcp_bounding_en(), 
      .control_test_point_en(), .observe_test_point_en(), .x_bounding_en(), .ijtag_so(msrv32_top_pass2_rtl_tessent_tdr_sri_ctrl_inst_so)
  );

  inv01 async_set_reset_dynamic_disable_inv_1(
      .A(tessent_persistent_cell_async_set_reset_dynamic_disable_Y), .Y(async_set_reset_dynamic_disable_inv_ts2)
  );

  and02 dft_ctrl_async_set_reset_dynamic_disable_inv_and2_1(
      .A0(ms_riscv32_mp_rst_in_toCore), .A1(async_set_reset_dynamic_disable_inv_ts2), 
      .Y(rst_pad_C)
  );

  msrv32_top_pass2_rtl_tessent_occ msrv32_top_pass2_rtl_tessent_occ_ms_riscv32_mp_clk_in_p_inst(
      .fast_clock(ms_riscv32_mp_clk_in_p_toCore), .slow_clock(shift_clock_out), 
      .scan_en(shift_en_out[1]), .capture_en(capture_en_out), .static_clock_control_mode(lbist_en), 
      .clock_sequence(occ1_clock_sequence), .shift_only_mode(1'b0), .ijtag_tck(tck_i_C), 
      .ijtag_reset(test_logic_reset), .ijtag_sel(ijtag_to_sel), .ijtag_ce(capture_dr_en), 
      .ijtag_se(shift_dr_en), .ijtag_ue(update_dr_en), .ijtag_si(msrv32_top_pass2_rtl_tessent_sib_lbist_inst_so), 
      .ijtag_so(ijtag_so), .clock_out(), .scan_in(1'b0), .scan_out()
  );

  msrv32_top_pass2_rtl_tessent_occ msrv32_top_pass2_rtl_tessent_occ_ramclk_p_inst(
      .fast_clock(ramclk_p_toCore), .slow_clock(shift_clock_out), .scan_en(shift_en_out[0]), 
      .capture_en(capture_en_out), .static_clock_control_mode(lbist_en), .clock_sequence(occ2_clock_sequence), 
      .shift_only_mode(1'b0), .ijtag_tck(tck_i_C), .ijtag_reset(test_logic_reset), 
      .ijtag_sel(ijtag_to_sel), .ijtag_ce(capture_dr_en), .ijtag_se(shift_dr_en), 
      .ijtag_ue(update_dr_en), .ijtag_si(ijtag_so), .ijtag_so(ijtag_so_ts1), .clock_out(), 
      .scan_in(1'b0), .scan_out()
  );

  msrv32_top_pass2_rtl_tessent_edt_lbist_c0 msrv32_top_pass2_rtl_tessent_edt_lbist_c0_inst(
      .edt_clock(edt_lbist_clock), .edt_update(edt_update_fromPad), .edt_low_power_shift_en(edt_low_power_shift_en), 
      .edt_bypass(edt_bypass), .edt_single_bypass_chain(edt_single_bypass_chain_out), 
      .edt_channels_in(to_edt_channels_in), .edt_channels_out(edt_channels_out), 
      .edt_scan_in(), .edt_scan_out(10'b0000000000), .lbist_reset(lbist_reset), 
      .lbist_en(lbist_en), .lbist_prpg_en(lbist_prpg_en), .misr_accumulate_en(misr_accumulate_en), 
      .lbist_low_power_shift_en(lbist_low_power_shift_en), .ijtag_tck(tck_i_C), 
      .ijtag_reset(test_logic_reset), .ijtag_sel(edt_sib_en), .ijtag_ce(capture_dr_en), 
      .ijtag_se(shift_dr_en), .ijtag_ue(update_dr_en), .ccm_en(control_chain_enable_fromPad), 
      .ccm_scan_en(ccm_scan_en), .ijtag_si(to_edt_scan_in), .ijtag_so(ijtag_so_ts4), 
      .lbist_misr()
  );

  msrv32_top_pass2_rtl_tessent_edt_lbist_c0_tdr msrv32_top_pass2_rtl_tessent_edt_lbist_c0_tdr_inst(
      .ijtag_reset(test_logic_reset), .ijtag_sel(ijtag_to_sel_ts1), .ijtag_si(msrv32_top_pass2_rtl_tessent_sib_occ_inst_so), 
      .ijtag_ce(capture_dr_en), .ijtag_se(shift_dr_en), .ijtag_ue(update_dr_en), 
      .ijtag_tck(tck_i_C), .edt_bypass(edt_bypass), .edt_low_power_shift_en(edt_low_power_shift_en), 
      .ijtag_so(ijtag_so_ts2)
  );

  msrv32_top_pass2_rtl_tessent_lbist_ncp_index_decoder msrv32_top_pass2_rtl_tessent_lbist_ncp_index_decoder_inst(
      .ncp_index(ncp), .occ1_clock_sequence(occ1_clock_sequence), .occ2_clock_sequence(occ2_clock_sequence)
  );

  msrv32_top_pass2_rtl_tessent_lbist msrv32_top_pass2_rtl_tessent_lbist_inst(
      .ijtag_tck(tck_i_C), .test_clock(edt_clock_fromPad), .shift_clock_src(shift_clock_src_p_pad_C), 
      .edt_lbist_clock(edt_lbist_clock), .shift_clock(), .to_edt_scan_in(to_edt_scan_in), 
      .from_edt_scan_out(ijtag_so_ts4), .ijtag_si(ijtag_so_ts5), .ijtag_so(ijtag_so_ts3), 
      .lbist_en(lbist_en), .lbist_reset(lbist_reset), .ccm_en(control_chain_enable_fromPad), 
      .ccm_scan_en(ccm_scan_en), .ccm_scan_out(ccm_scan_out), .lbist_low_power_shift_en(lbist_low_power_shift_en), 
      .scan_en_in(scan_en_ts1), .scan_en_out(msrv32_top_pass2_rtl_tessent_lbist_tmp_net), 
      .shift_clock_in(shift_capture_clock_pad_C), .shift_clock_out(shift_clock_out), 
      .shift_en_in({scan_en_ts1, scan_en_ts1}), .shift_en_out(shift_en_out[1:0]), 
      .capture_en_in(inv_Y), .capture_en_out(capture_en_out), .ncp(ncp), .lbist_prpg_en(lbist_prpg_en), 
      .misr_accumulate_en(misr_accumulate_en), .capture_en(), .ijtag_reset(test_logic_reset), 
      .ijtag_sel(ijtag_to_sel_ts2), .ijtag_ce(capture_dr_en), .ijtag_se(shift_dr_en), 
      .ijtag_ue(update_dr_en), .edt_sib_en(edt_sib_en)
  );

  msrv32_top_pass2_rtl_tessent_single_chain_mode_logic msrv32_top_pass2_rtl_tessent_single_chain_mode_logic_inst(
      .ijtag_tck(tck_i_C), .lbist_en(lbist_en), .ijtag_reset(test_logic_reset), 
      .ijtag_sel(ijtag_to_sel_ts2), .ijtag_ce(capture_dr_en), .ijtag_se(shift_dr_en), 
      .ijtag_ue(update_dr_en), .ccm_en(control_chain_enable_fromPad), .ccm_scan_en(ccm_scan_en), 
      .ccm_scan_in(control_chain_scan_in_fromPad), .ijtag_si(msrv32_top_pass1_rtl_tessent_sib_sri_ctrl_inst_so), 
      .edt_single_bypass_chain_in(1'b0), .edt_channels_in(edt_channel_in1_p_fromPad), 
      .edt_channels_out(edt_channels_out), .ijtag_so(ijtag_so_ts5), .edt_single_bypass_chain_out(edt_single_bypass_chain_out), 
      .to_edt_channels_in(to_edt_channels_in)
  );

  inv01 inv(
      .A(scan_en_ts1), .Y(inv_Y)
  );
endmodule