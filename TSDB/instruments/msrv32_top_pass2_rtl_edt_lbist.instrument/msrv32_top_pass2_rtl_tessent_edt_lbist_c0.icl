...
Module msrv32_top_pass2_rtl_tessent_edt_lbist_c0 {
   ...
   Instance msrv32_top_pass2_rtl_tessent_edt_c0_sib_decompressor_i Of msrv32_top_pass2_rtl_tessent_edt_c0_sib {
   ...
   ScanRegister lbist_lp_hold_reg[3:0] {
      ScanInSource msrv32_top_pass2_rtl_tessent_edt_c0_sib_decompressor_i.ijtag_so;
   }
   ...
   Instance msrv32_top_pass2_rtl_tessent_edt_c0_sib_lbist_lp_static_control_i Of msrv32_top_pass2_rtl_tessent_edt_c0_sib {
      InputPort ijtag_si = msrv32_top_pass2_rtl_tessent_edt_c0_sib_decompressor_i.ijtag_so;
      InputPort ijtag_tck = ijtag_tck;
      InputPort ijtag_reset = ijtag_reset;
      InputPort ijtag_sel = ijtag_sel;
      InputPort ijtag_ce = ijtag_ce;
   ...
   ScanRegister lbist_lp_mask_shift_reg[30:0] {
      ScanInSource msrv32_top_pass2_rtl_tessent_edt_c0_sib_lbist_lp_static_control_i.ijtag_so;
   }
   Instance msrv32_top_pass2_rtl_tessent_edt_c0_sib_lbist_lp_mask_shift_reg_i Of msrv32_top_pass2_rtl_tessent_edt_c0_sib {
      InputPort ijtag_si = msrv32_top_pass2_rtl_tessent_edt_c0_sib_lbist_lp_static_control_i.ijtag_so;
      InputPort ijtag_tck = ijtag_tck;
      InputPort ijtag_reset = ijtag_reset;
      InputPort ijtag_sel = ijtag_sel;
      InputPort ijtag_ce = ijtag_ce;
   ...
   ScanRegister bist_chain_mask[9:0] {
      ScanInSource msrv32_top_pass2_rtl_tessent_edt_c0_sib_lbist_lp_mask_shift_reg_i.ijtag_so;
   }
   ...
   Instance msrv32_top_pass2_rtl_tessent_edt_c0_sib_chain_mask_i Of msrv32_top_pass2_rtl_tessent_edt_c0_sib {
      InputPort ijtag_si = msrv32_top_pass2_rtl_tessent_edt_c0_sib_lbist_lp_mask_shift_reg_i.ijtag_so;
      InputPort ijtag_tck = ijtag_tck;
      InputPort ijtag_reset = ijtag_reset;
      InputPort ijtag_sel = ijtag_sel;
      InputPort ijtag_ce = ijtag_ce;
   ...
   Instance msrv32_top_pass2_rtl_tessent_edt_c0_sib_misr_i Of msrv32_top_pass2_rtl_tessent_edt_c0_sib {
      InputPort ijtag_si = msrv32_top_pass2_rtl_tessent_edt_c0_sib_chain_mask_i.ijtag_so;
      InputPort ijtag_tck = ijtag_tck;
      InputPort ijtag_reset = ijtag_reset;
      InputPort ijtag_sel = ijtag_sel;
      InputPort ijtag_ce = ijtag_ce;
   ...
   Attribute tessent_instrument_container = "msrv32_top_pass2_rtl_edt_lbist.instrument";
