...
buf02 tessent_persistent_cell_edt_low_power_shift_en ( .A (edt_low_power_shift_en_latch), .Y (edt_low_power_shift_en) );
buf02 tessent_persistent_cell_edt_bypass ( .A (edt_bypass_latch), .Y (edt_bypass) );
