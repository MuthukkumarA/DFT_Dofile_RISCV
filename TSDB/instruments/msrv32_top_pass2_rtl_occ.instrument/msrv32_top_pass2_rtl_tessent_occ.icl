...
Module msrv32_top_pass2_rtl_tessent_occ {
   ...
   DataInPort static_clock_control_mode { Attribute connection_rule_option = "allowed_tied"; Attribute tessent_use_in_dft_specification = "false"; }
   ...
   Attribute tessent_instrument_container = "msrv32_top_pass2_rtl_occ.instrument";
