...
Header {
  Title "CTL for design 'msrv32_top_pass2_rtl_tessent_occ'";
  Date "Tue Apr 07 17:43:10 IST 2026";
  Source "Tessent Shell 2022.2";
}
Signals {
  fast_clock In;
  slow_clock In;
...
Environment msrv32_top_pass2_rtl_tessent_occ {
