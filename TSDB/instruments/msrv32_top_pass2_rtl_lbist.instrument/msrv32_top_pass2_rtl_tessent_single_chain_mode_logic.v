...
module msrv32_top_pass2_rtl_tessent_single_chain_mode_logic (
   ...
   assign ijtag_so = ccm_scan_en ? ccm_te_so_blk1_sib : single_chain_sib_scan_out;
   ...
   msrv32_top_pass2_rtl_tessent_single_chain_mode_logic_sib tdr_sib_i (
      .ijtag_tck(ijtag_tck),
   ...
   buf02 tessent_persistent_cell_tdr_single_bypass_buf (.A(tdr_single_bypass),
                                                        .Y(tdr_single_bypass_buf_out));

   msrv32_top_pass2_rtl_tessent_single_chain_mode_logic_sib single_chain_sib_i (
      .ijtag_tck(ijtag_tck),
      .ijtag_reset(ijtag_reset),
      .ijtag_sel(ijtag_sel_ccm),
      .ijtag_ce(ijtag_ce_ccm),
   ...
   msrv32_top_pass2_rtl_tessent_single_chain_mode_logic_sib blk1_sib_i (
      .ijtag_tck(ijtag_tck),
      .ijtag_reset(ijtag_reset),
